...
{
    public static StorageConst Current { get; protected set; } = default!;
    ...
    public virtual StorageLog Log { protected set; get; } = default!;

    public virtual StorageTrace Trace { protected set; get; } = default!;
}
